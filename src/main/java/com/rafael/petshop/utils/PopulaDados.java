...
import com.rafael.petshop.repositories.PagamentoRepository;
...
public class PopulaDados {
	...
	public void cadastrar() throws ParseException {
		...
		Servico srv3= new Servico(null, sdf.parse("05/09/2021 12:00"), sdf.parse("05/09/2021 16:30"), "Vermifugação", clt1, fnc1,pet3);
		...
		Pagamento pgt3= new PagDinheiro(null, 75.00, SituacaoPagamento.QUITADO, srv3, sdf.parse("05/09/2021 16:00"), null);
